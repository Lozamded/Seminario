...
class FichasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ficha" do
    assert_difference('Ficha.count') do
      post fichas_url, params: { ficha: { comuna: @ficha.comuna, direccion: @ficha.direccion, email: @ficha.email, nombre: @ficha.nombre, sexo: @ficha.sexo, telefono: @ficha.telefono } }
    end
  ...
  test "should update ficha" do
    patch ficha_url(@ficha), params: { ficha: { comuna: @ficha.comuna, direccion: @ficha.direccion, email: @ficha.email, nombre: @ficha.nombre, sexo: @ficha.sexo, telefono: @ficha.telefono } }
