...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { cantidad: @medicamento.cantidad, frecuencia: @medicamento.frecuencia, nombre: @medicamento.nombre } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { cantidad: @medicamento.cantidad, frecuencia: @medicamento.frecuencia, nombre: @medicamento.nombre } }
