...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference('Veterinario.count') do
      post veterinarios_url, params: { veterinario: { especialidad: @veterinario.especialidad, fecha_nacimiento: @veterinario.fecha_nacimiento, nombre: @veterinario.nombre, rut: @veterinario.rut, sexo: @veterinario.sexo, tipo: @veterinario.tipo } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { especialidad: @veterinario.especialidad, fecha_nacimiento: @veterinario.fecha_nacimiento, nombre: @veterinario.nombre, rut: @veterinario.rut, sexo: @veterinario.sexo, tipo: @veterinario.tipo } }
